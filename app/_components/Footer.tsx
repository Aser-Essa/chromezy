...
export default function Footer() {
  return (
    <div className="h-[468px] bg-[#080A12] px-[120px] pt-[64px] max-lg:px-14 max-md:h-auto">
      ...
      <div className="mt-20 flex h-20 w-full items-center justify-between text-nowrap border-t border-[#ffffff0d] text-xs text-[#ffffff99] max-lg:h-auto max-lg:flex-col max-lg:justify-center max-lg:gap-5 max-md:mt-12 max-md:py-4 max-sm:mb-2.5">
